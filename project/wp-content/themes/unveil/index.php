...
================================================== -->
    ...
    <div class="row">
        <div class="col-sm-4" id="feature1">
            <a href="#"><img class="img-circle" src="img/baguette.jpg" alt="Generic placeholder image"></a>
        ...
        <div class="col-sm-4" id="feature2">
            <a href="#"><img class="img-circle" src="img/pierogis-small.jpg" alt="Generic placeholder image"></a>
        ...
        <div class="col-sm-4" id="feature3">
            <a href="#"><img class="img-circle" src="img/grilled.jpg" alt="Generic placeholder image"></a>
...
================================================== -->
    ...
    <div class="row">
        <div class="col-sm-4" id="feature4">
            <a href="#"><img class="img-circle" src="img/bento.jpg" alt="Generic placeholder image"></a>
        ...
        <div class="col-sm-4" id="feature5">
            <a href="#"><img class="img-circle" src="img/pinwheel-small.jpg" alt="Generic placeholder image"></a>
        ...
        <div class="col-sm-4"  id="feature6">
            <a href="#"><img class="img-circle" src="img/appetizers.jpg" alt="Generic placeholder image"></a>
